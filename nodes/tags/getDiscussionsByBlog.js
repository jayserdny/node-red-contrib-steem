...
module.exports = (RED) => {
    "use strict";
    function getDiscussionsByBlogNode(config) {
        ...
        node.on('input', (msg) => {
            ...
            steem.api.getDiscussionsByBlog(JSON.stringify(query), (err, response) => {
    ...
    RED.nodes.registerType("getDiscussionsByBlog", getDiscussionsByBlogNode);
  }