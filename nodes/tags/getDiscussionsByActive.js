...
module.exports = (RED) => {
    "use strict";
    function getDiscussionsByActiveNode(config) {
        ...
        node.on('input', (msg) => {
            ...
            steem.api.getDiscussionsByActive(JSON.stringify(query), (err, response) => {
    ...
    RED.nodes.registerType("getDiscussionsByActive", getDiscussionsByActiveNode);
  }