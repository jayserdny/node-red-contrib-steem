...
module.exports = (RED) => {
    "use strict";
    function getDiscussionsByCreatedNode(config) {
        ...
        node.on('input', (msg) => {
            ...
            steem.api.getDiscussionsByCreated(JSON.stringify(query), (err, response) => {
    ...
    RED.nodes.registerType("getDiscussionsByCreated", getDiscussionsByCreatedNode);
  }