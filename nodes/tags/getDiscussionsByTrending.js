...
module.exports = (RED) => {
    "use strict";
    function getDiscussionsByTrendingNode(config) {
        ...
        node.on('input', (msg) => {
            ...
            steem.api.getDiscussionsByTrending(JSON.stringify(query), (err, response) => {
    ...
    RED.nodes.registerType("getDiscussionsByTrending", getDiscussionsByTrendingNode);
  }