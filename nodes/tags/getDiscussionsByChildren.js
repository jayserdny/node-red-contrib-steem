...
module.exports = (RED) => {
    "use strict";
    function getDiscussionsByChildrenNode(config) {
        ...
        node.on('input', (msg) => {
            ...
            steem.api.getDiscussionsByChildren(JSON.stringify(query), (err, response) => {
    ...
    RED.nodes.registerType("getDiscussionsByChildren", getDiscussionsByChildrenNode);
  }