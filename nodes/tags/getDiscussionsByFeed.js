...
module.exports = (RED) => {
    "use strict";
    function getDiscussionsByFeedNode(config) {
        ...
        node.on('input', (msg) => {
            ...
            steem.api.getDiscussionsByFeed(JSON.stringify(query), (err, response) => {
    ...
    RED.nodes.registerType("getDiscussionsByFeed", getDiscussionsByFeedNode);
  }