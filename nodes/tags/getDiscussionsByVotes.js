...
module.exports = (RED) => {
    "use strict";
    function getDiscussionsByVotesNode(config) {
        ...
        node.on('input', (msg) => {
            ...
            steem.api.getDiscussionsByVotes(JSON.stringify(query), (err, response) => {
    ...
    RED.nodes.registerType("getDiscussionsByVotes", getDiscussionsByVotesNode);
  }