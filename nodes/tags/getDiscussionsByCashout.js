...
module.exports = (RED) => {
    "use strict";
    function getDiscussionsByCashoutNode(config) {
        ...
        node.on('input', (msg) => {
            ...
            steem.api.getDiscussionsByCashout(JSON.stringify(query), (err, response) => {
    ...
    RED.nodes.registerType("getDiscussionsByCashout", getDiscussionsByCashoutNode);
  }