...
module.exports = (RED) => {
    "use strict";
    function getDiscussionsByCommentsNode(config) {
        ...
        node.on('input', (msg) => {
            ...
            steem.api.getDiscussionsByComments(JSON.stringify(query), (err, response) => {
    ...
    RED.nodes.registerType("getDiscussionsByComments", getDiscussionsByCommentsNode);
  }