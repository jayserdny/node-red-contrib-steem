...
module.exports = (RED) => {
    "use strict";
    function getTrendingTagsNode(config) {
        ...
        node.on('input', (msg) => {
            ...
            let validation = validateParams(param.afterTag, param.limit);
            ...
            let afterTag = param.afterTag.trim();
            let limit = ParseInt(param.limit.trim());

            steem.api.getTrendingTags(afterTag, limit, (err, response) => {
    ...
    RED.nodes.registerType("getTrendingTags", getTrendingTagsNode);
  }