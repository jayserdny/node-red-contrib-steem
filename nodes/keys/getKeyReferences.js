...
module.exports = (RED) => {
    "use strict";
    function getKeyReferencesNode(config) {
        ...
        node.on('input', (msg) => {
            ...
            let validation = validateParams(param.key);
            ...
            steem.api.getKeyReferences(key, (err, response) => {
    ...
    RED.nodes.registerType("getKeyReferences", getKeyReferencesNode);
  }